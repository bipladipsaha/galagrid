...
1. **Hardware (ESP32 Edge Device)**: Collects sensor data and controls actuators in the field.
2. **Web Dashboard (Next.js UI)**: Provides a premium, interactive interface for monitoring, AI diagnostics, and chemical safety checks.
...
2. Install required libraries:
   ...
   - `ESP32Servo`
3. Update your WiFi credentials and Firebase API keys in the code.
